...
class UserBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_book" do
    assert_difference('UserBook.count') do
      post user_books_url, params: { user_book: { book_id: @user_book.book_id, favorite: @user_book.favorite, read: @user_book.read, reading: @user_book.reading, request: @user_book.request, user_id: @user_book.user_id } }
    end
  ...
  test "should update user_book" do
    patch user_book_url(@user_book), params: { user_book: { book_id: @user_book.book_id, favorite: @user_book.favorite, read: @user_book.read, reading: @user_book.reading, request: @user_book.request, user_id: @user_book.user_id } }
